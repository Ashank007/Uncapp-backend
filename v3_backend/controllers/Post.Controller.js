...
try {
 ...
 const data = {url:url,caption:caption};
...
export { CreatePost, EditPost, DeletePost, GetAllUserPost, GetPost, LikePost, SavePost, GetAllSavePost, AddComment, GetComments, GetAllUserFollowingPost, UploadVideo,GetAllUserVideos }
