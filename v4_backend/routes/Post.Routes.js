...
import { AddComment, CreatePost, EditPost, GetAllSavePost, GetAllUserFollowingPost, GetAllUserPost, GetAllUserVideos, GetComments, GetPost, LikePost, SavePost, UploadVideo } from '../controllers/Post.Controller.js';
...
PostRouter.post("/add/video",isauthenticated,UploadVideo);
PostRouter.get("/get/videos",isauthenticated,GetAllUserVideos);
