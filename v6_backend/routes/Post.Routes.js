...
import { AddComment, CreatePost, EditPost, GetAllSavePost, GetAllUserFollowingPost, GetAllUserPost, GetComments, GetPost, LikePost, SavePost, SharePost} from '../controllers/Post.Controller.js';
...
PostRouter.get("/share/:id",SharePost);
